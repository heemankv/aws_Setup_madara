...
# Base configuration
export MADARA_ORCHESTRATOR_AWS_PREFIX="test"
export MADARA_ORCHESTRATOR_AWS_S3_BUCKET_IDENTIFIER="orchestrator-bucket"
export MADARA_ORCHESTRATOR_AWS_SQS_QUEUE_IDENTIFIER_TEMPLATE="orchestrator_{}_queue"
export MADARA_ORCHESTRATOR_AWS_SNS_TOPIC_IDENTIFIER="orchestrator-alerts"
...
export SQS_QUEUE_NAME="${MADARA_ORCHESTRATOR_AWS_PREFIX}_${MADARA_ORCHESTRATOR_AWS_SQS_QUEUE_IDENTIFIER_TEMPLATE}"
